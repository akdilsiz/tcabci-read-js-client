...
export declare const TX_TYPE_MASTER: TXType,
  ...
  TX_TYPE_DATA_ROOME: TXType,
  TX_TYPE_DATA_ROOME_DATA: TXType,
  ...
  TX_TYPE_MULTI_COLLECTION: TXType,
  TX_TYPE_MULTI_DATAV2: TXType,
  ...
  TX_TYPE_DATAV2: TXType,
  TX_TYPE_DATAV2_POLICY: TXType,
